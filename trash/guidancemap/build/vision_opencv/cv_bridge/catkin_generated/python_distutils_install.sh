...
echo_and_run cd "/home/wsn/HKU_UAV_Project/guidancemap/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/wsn/HKU_UAV_Project/guidancemap/src/vision_opencv/cv_bridge/setup.py" \
    build --build-base "/home/wsn/HKU_UAV_Project/guidancemap/build/vision_opencv/cv_bridge" \
    install \
    $DESTDIR_ARG \
