...
echo_and_run cd "/home/wsn/HKU_UAV_Project/guidancemap/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/wsn/HKU_UAV_Project/guidancemap/src/vision_opencv/image_geometry/setup.py" \
    build --build-base "/home/wsn/HKU_UAV_Project/guidancemap/build/vision_opencv/image_geometry" \
    install \
    $DESTDIR_ARG \
