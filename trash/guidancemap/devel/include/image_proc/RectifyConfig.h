...
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RectifyConfig::AbstractParamDescriptionConstPtr(new RectifyConfig::ParamDescription<int>("interpolation", "int", 0, "Interpolation algorithm between source image pixels", "{'enum_description': 'interpolation type', 'enum': [{'srcline': 9, 'description': 'Nearest neighbor', 'srcfile': '/home/wsn/HKU_UAV_Project/guidancemap/src/vision_opencv/image_pipeline/image_proc/cfg/Rectify.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'NN'}, {'srcline': 10, 'description': 'Linear', 'srcfile': '/home/wsn/HKU_UAV_Project/guidancemap/src/vision_opencv/image_pipeline/image_proc/cfg/Rectify.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Linear'}, {'srcline': 11, 'description': 'Cubic', 'srcfile': '/home/wsn/HKU_UAV_Project/guidancemap/src/vision_opencv/image_pipeline/image_proc/cfg/Rectify.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Cubic'}, {'srcline': 12, 'description': 'Lanczos4', 'srcfile': '/home/wsn/HKU_UAV_Project/guidancemap/src/vision_opencv/image_pipeline/image_proc/cfg/Rectify.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'Lanczos4'}]}", &RectifyConfig::interpolation)));
//#line 293 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/wsn/HKU_UAV_Project/guidancemap/src/vision_opencv/image_pipeline/image_proc/cfg/Rectify.cfg"
      const int Rectify_NN = 0;
//#line 10 "/home/wsn/HKU_UAV_Project/guidancemap/src/vision_opencv/image_pipeline/image_proc/cfg/Rectify.cfg"
      const int Rectify_Linear = 1;
//#line 11 "/home/wsn/HKU_UAV_Project/guidancemap/src/vision_opencv/image_pipeline/image_proc/cfg/Rectify.cfg"
      const int Rectify_Cubic = 2;
//#line 12 "/home/wsn/HKU_UAV_Project/guidancemap/src/vision_opencv/image_pipeline/image_proc/cfg/Rectify.cfg"
