...
if("TRUE" STREQUAL "TRUE")
  set(camera_calibration_parsers_SOURCE_PREFIX /home/wsn/HKU_UAV_Project/guidancemap/src/image_common/camera_calibration_parsers)
  set(camera_calibration_parsers_DEVEL_PREFIX /home/wsn/HKU_UAV_Project/guidancemap/devel)
  ...
  set(camera_calibration_parsers_INSTALL_PREFIX /home/wsn/HKU_UAV_Project/guidancemap/install)
...
if(NOT "/home/wsn/HKU_UAV_Project/guidancemap/src/image_common/camera_calibration_parsers/include " STREQUAL " ")
  set(camera_calibration_parsers_INCLUDE_DIRS "")
  set(_include_dirs "/home/wsn/HKU_UAV_Project/guidancemap/src/image_common/camera_calibration_parsers/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_calibration_parsers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wsn/HKU_UAV_Project/guidancemap/src/image_common/camera_calibration_parsers/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
