...
if("TRUE" STREQUAL "TRUE")
  set(pcl_conversions_SOURCE_PREFIX /home/wsn/HKU_UAV_Project/catkin_ws/src/pcl_conversions)
...
if(NOT "/home/wsn/HKU_UAV_Project/catkin_ws/src/pcl_conversions/include;/usr/include/eigen3;/usr/include;/usr/include/pcl-1.7 " STREQUAL " ")
  set(pcl_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/wsn/HKU_UAV_Project/catkin_ws/src/pcl_conversions/include;/usr/include/eigen3;/usr/include;/usr/include/pcl-1.7")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcl_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wsn/HKU_UAV_Project/catkin_ws/src/pcl_conversions/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>, Bill Morris <bill@neautomation.com>' to fix it.")
    endif()
