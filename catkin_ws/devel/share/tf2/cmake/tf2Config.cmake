...
if("TRUE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /home/wsn/HKU_UAV_Project/catkin_ws/src/geometry2/tf2)
  set(tf2_DEVEL_PREFIX /home/wsn/HKU_UAV_Project/catkin_ws/devel)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /home/wsn/HKU_UAV_Project/catkin_ws/install)
...
if(NOT "/home/wsn/HKU_UAV_Project/catkin_ws/src/geometry2/tf2/include;/usr/include " STREQUAL " ")
  set(tf2_INCLUDE_DIRS "")
  set(_include_dirs "/home/wsn/HKU_UAV_Project/catkin_ws/src/geometry2/tf2/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wsn/HKU_UAV_Project/catkin_ws/src/geometry2/tf2/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(tf2_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "tf2;/usr/lib/i386-linux-gnu/libconsole_bridge.so")
